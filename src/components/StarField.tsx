...
export default function StarField() {
  ...
  return (
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
      {/* Nền trời đêm hồng — nhiều chặng màu để chuyển thật mượt, không bị gắt */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_50%_-10%,#8a4a72_0%,#663a5c_22%,#4a2745_45%,#2f1830_68%,#1e0f1c_85%,#170a14_100%)]" />

      {/* Vệt tinh vân hồng tím mơ màng */}
      <div className="absolute top-[10%] -left-[10%] h-[45vh] w-[60vw] rounded-full bg-pink-400/10 blur-[130px]" />
      <div className="absolute right-[-5%] bottom-[15%] h-[40vh] w-[50vw] rounded-full bg-fuchsia-400/8 blur-[140px]" />
      <div className="absolute top-[45%] left-[30%] h-[35vh] w-[40vw] rounded-full bg-rose-400/8 blur-[120px]" />
      <div className="absolute top-[70%] right-[15%] h-[30vh] w-[35vw] rounded-full bg-purple-500/10 blur-[130px]" />
      ...
      <motion.div
        className="absolute inset-0 bg-[radial-gradient(ellipse_at_50%_100%,rgba(251,191,36,0.22)_0%,rgba(244,114,182,0.25)_35%,transparent_70%)]"
        style={{ opacity: dawn }}
      />
    </div>
  )
