...
export const CHAPTERS: Chapter[] = [
  ...
  },
  {
    ...
    photos: [
      { src: '/photos/chuyen-di-1.jpg' },
      { src: '/photos/chuyen-di-2.jpg' },
      { src: '/photos/chuyen-di-3.jpg' },
      { src: '/photos/chuyen-di-4.jpg' },
      { src: '/photos/chuyen-di-5.jpg' },
      { src: '/photos/chuyen-di-6.jpg' },
    ],
    layout: 'grid',
  },
  {
